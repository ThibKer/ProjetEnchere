...
<title>
	<fmt:message key="t_end_vendeur" bundle="${r}"></fmt:message>
</title>
</head>
<body>
	<label for="st">
	   <fmt:message key="st_end_vendeur" bundle="${r}"></fmt:message>
	...
	<form action="HomeServlet" method="POST" class="f-win-vente">
	  ...
	  <div>
	    <fmt:message key="btn_retrait_effectue" bundle="${r}" var="retrait"/>   
		<input type="submit" name="ok" value="${retrait}">
	  </div>
